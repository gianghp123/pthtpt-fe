...
export function ElectionHistoryModal({
  elections,
}: ElectionHistoryModalProps) {
          ...
          {elections.length === 0 ? (
            <div className="text-center py-12 bg-white/10 rounded-2xl border border-white/20">
              ...
              <p className="text-white/40 text-sm mt-2">
                Kill a leader node to trigger an election
              </p>
            </div>
          ) : (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div className="bg-white/5 rounded-xl p-3 border border-white/10">
                    ...
                    <p className="text-white">
                      {election.oldLeaderId
                        ? `Node ${election.oldLeaderId}`
                        : "None"}
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-xl p-3 border border-white/10">
                    ...
                    <p className="text-white">
                      {election.candidates.length} nodes
                    </p>
                  </div>
                </div>
